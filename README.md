...
* Mirror of [thisProject](https://github.com/Klerith/flutter-qr-googlemaps), but updated to v2
  * Scan a qr, displaying it's content (even if the content is google map's reference)
...
* Configuration needed by the dependencies
  ...
  * 'google_maps_flutter'
    * Follow [getting started section](https://pub.dev/packages/google_maps_flutter#getting-started)
...
## Notes:
* 'https://qrplanet.com/es'
  * web page to generate qr codes
* TODO:
